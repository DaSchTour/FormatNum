...
class FormatNumHooks {
	 ...
	 * @param $parser Parser from mediawiki
	 * @return bool must return true for next parsers
	 **/
	public static function efFormatNumParserFunction_Setup( $parser ) {
	 ...
	 **/
	public static function efFormatNumParserFunction_Render( &$parser ) {
